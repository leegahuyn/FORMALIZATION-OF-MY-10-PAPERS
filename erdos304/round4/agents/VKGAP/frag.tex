...
(b) 인자 $|\tau|/(2\pi T)$: $\le\frac1{2\pi}\int\frac{|\tau|}{2\pi T}e^{-\tau^2V/2}d\tau=\frac1{2\pi^2TV}\le10^{-4}V^{-1/2}$;
...
합: $0.0064+0.0001+0.0128+0.0013+0.002<0.0226$. 따라서 $\mathbb{E}F_T(S-s)\ge0.376\,V^{-1/2}$.
...
$T\cdot\Pr(|S-s|\le2/T)\ge\mathbb{E}[F_T(S-s);|S-s|\le2/T]\ge(0.376-0.2033)V^{-1/2}>0$.
...
p1p4 주~5.19(c)는 이 경로를 \HEUR/\OPEN으로 남겼다; 정리~\ref{VKGAP:thm-A}는 그것을 교과서 입력만으로 완성한다.
...
이 절의 가치는 (1) $\Lam_L$에 대한 약수 간격 정리 (정리~\ref{VKGAP:thm-A}; $\Lam_L$ 자체의 $h(\Lam_L)=H(L)$의
첫 $o(L/\log L)$ 경계), (2) 아래 \S\ref{VKGAP:sec-C}의 조건부 사다리에서 같은 기계가 그대로 쓰인다는 점이다.
