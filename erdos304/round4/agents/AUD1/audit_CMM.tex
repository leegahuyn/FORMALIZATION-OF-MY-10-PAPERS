...
\endhead
보조정리 \texttt{lem-N1} & PROVED (F2) & CONFIRMED & $N_1\ge\pi(L/2)-\pi(\sqrt L)-\omega$, Rosser--Schoenfeld 두 부등식, $\sqrt L\ge21.06$. 수치: $444\le L\le2\cdot10^5$에서 실패 없음(최소 비 $1.48$); 실제로는 $82\le L\le2\cdot10^5$ 전체에서 성립.\\
